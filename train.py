"""Step 3 — train XGBoost with GridSearchCV and register best model on HF Hub."""
import os, warnings
...
joblib.dump(best, "tourism_project/best-tourism-model-v1.joblib")
...
api.upload_file(
    path_or_fileobj="tourism_project/best-tourism-model-v1.joblib",
    path_in_repo="best-tourism-model-v1.joblib",
    repo_id=MODEL_REPO,
    repo_type="model",
    token=HF_TOKEN,
    commit_message="CI: register best model",
)
